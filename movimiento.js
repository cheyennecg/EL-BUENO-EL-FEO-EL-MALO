        ...
        const data = {
            pallet: { name: "PUEBLO PALETA", leader: "Cheyenne", type: "INICIO", color: "#ccc", poke: "📱", as: "Starter", desc: "Aquí comienza tu aventura. ¡Elige bien a tu compañero!" },
            ...
            lavanda: { name: "PUEBLO VILLANUEVA", leader: "Anaïs", type: "HADA", color: "#705898", poke: "🌙", as: "Clefable", desc: "Ciudad tranquila. Te guíaran Lupi,Indi y Simbita a la Torre Pokémon. " }
        };
        ...
        function updateBattle(key) {
            ...
            // Actualizar Sprite y Nombre del Pokémon Rival
            display.querySelector('.sprite-box').innerHTML = info.poke;
            display.querySelector('h3').innerText = "Rival: " + info.as;
